    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        <div className="relative w-full h-[230px]">
          ...
          {/* Can add additional link for website url similar to above github url */}
        </div>
        <div className="mt-5">
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          The following projects provide a glimpse into my work, emphasizing my skills in software engineering. 
          Each project is outlined with a short description and includes links to the corresponding code repositories, 
